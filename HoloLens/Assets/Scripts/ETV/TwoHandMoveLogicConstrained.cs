// Author: Georg Eckert
// based on TwoHandMoveLogic by Microsoft from the Mixed Reality Toolkit
// 
// changed some code to add constraints for movement
//
// Original Copyright
...
namespace HoloToolkit.Unity.InputModule.Utilities.Interactions
{
    ...
    public class TwoHandMoveLogicConstrained
    {
        ...
        private static readonly Vector3 initialMove = new Vector3(0, 0, 0);
        #endregion
